...
<div id="sidebar" class="col-12 col-md-3 col-lg-2 px-0 bg-orange text-white">
    ...
    <ul class="nav flex-column">
        ...
        <li><a href="./ticketsmanagement.php" class="nav-link text-white active"><i class="bi bi-ticket-perforated"></i> Tickets</a></li>
    ...
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-12">
                ...
                <p class="text-muted">Manage and monitor your tickets effectively. Here, you can track ticket status, assigned personnel, and resolutions.</p>
                <p class="text-muted">Use the options below to review ticket status, assign new tickets, and ensure timely resolutions.</p>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-12">
                ...
                <p class="text-muted mb-3">Review and manage your ticket inventory. Below is the list of all open, pending, and resolved tickets.</p>
